...
@Component({
  selector: 'app-city-guide-stay',
  templateUrl: './city-guide-stay.component.html',
  styleUrls: ['./city-guide-stay.component.css']
})
export class CityGuideStayComponent implements OnInit {
  list : any[] = [];
  guideOptId: any;
  choosedOpt: any="";
